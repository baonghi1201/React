...
import { Breadcrumb, BreadcrumbItem, Button, Row , Label, Input, Col,
                                ...
                                <Col md={8}>
                                    ...
                                    <Errors className='text-danger'
                                            ...
                                            messages={{
                                                ...
                                                maxLength:'Must be 13 character or less'
                                            }}/>
                                </Col>
                            </Row >
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={8}>
                                    ...
                                    <Errors className='text-danger'
                                            ...
                                            messages={{
                                                required:'Required',
                                                validEmail:'Invalid email address or must contain "@" character'
                                            }}/>
